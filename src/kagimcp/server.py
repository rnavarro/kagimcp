...
def kagi_search_fetch(
    ...
    lens_id: str | None = Field(
        ...
        description=(
            ...
            "Custom lens IDs for this account: "
            "'29538' (Dev Code — programming without SEO spam, excludes medium/dev.to/geeksforgeeks), "
            "'4248' (Fediverse Forums — Lemmy & kbin), "
            "'5648' (Usenet/Archive — Usenet Archives and Archive.org), "
            "'3271' (Kagi Documentation — help.kagi.com, blog.kagi.com), "
            "'16640' (City of Corona), "
            "'3' (PDFs — search for PDF files), "
            "'4583' (Cyber Security — security news sites), "
            "'19487' (Jobs — job listings from company websites). "
